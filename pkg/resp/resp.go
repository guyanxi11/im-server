// Package resp 提供统一�?HTTP JSON 响应格式
// 作�? wym
// 约定：{"code": 0, "message": "ok", "data": ...}；code �?0 表示业务错误
package resp
...
// Body 是统一响应体结�?type Body struct {
	Code    int         `json:"code"`
	Message string      `json:"message"`
	Data    interface{} `json:"data,omitempty"`
}

// OK 返回成功响应，HTTP 状态码固定 200，业�?code 固定 0
...
// 例如：参数错误用 400 + code=1001，未授权�?401 + code=1002
